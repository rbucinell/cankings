...
document.title = "Promotions - Can Kings"
</script>
...
<template>
    <div class="container mx-auto p-1">
        ...
        <h1 class="text-5xl">Promotions</h1>
        <p class="lg:text-lg">We offer many ways to make your can return experience even better.</p>
        <div class="card card-side bg-base-100 shadow-xl mb-4">
            <div class="card-body">
                <h2 class="card-title">6¢ on the 6th</h2>
                <p class="lg:text-lg">On the 6th of every month, we offer 6¢ for each NY 5¢ deposit can or bottle you return.</p>
                                <h2 class="card-title">Education Outreach</h2>
                <p class="lg:text-lg">Any school to open an account will recceive 6¢ on all of their returns.</p>
            </div>
            <figure>
                <img src="../assets/img/6_on_6th.png" class="w-32 rounded" alt="six cents on the sixth image">
